...
package Lined.Buffer with Abstract_State => State, Initializes => State is
   ...
   procedure Write (File_Name : in String := "") with
      Global => State;
